...
plt.xlim(0,4000)
plt.ylim(0,700)
ax.annotate('afterpulse', xy=(300, 250), xytext=(300, 300),arrowprops=dict(facecolor='black', shrink=0.05),)
ax.annotate('original pulse', xy=(250, 500), xytext=(380, 490),arrowprops=dict(facecolor='black', shrink=0.05),)
